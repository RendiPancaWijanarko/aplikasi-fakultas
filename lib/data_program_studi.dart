List<Map<String, dynamic>> programStudiData = [
  {
    ...
    'programImage': 'assets/images/prodi/kewirausahaan/kewirausahaan.png',
    'programWebsiteTitle': 'Website Program Studi Kewirausahaan',
    'programWebsiteText':
        'Kunjungi situs web resmi program studi kewirausahaan berikut untuk mendapatkan informasi lebih lanjut yang mungkin tidak ada di aplikasi seluler:',
    'programWebsite': 'https://kwu.upnjatim.ac.id/',
    'programVisi':
    ...
    'programMisi': '1. Menyelenggarakan dan mengembangkan pendidikan di bidang kewirausahaan yang berbasis digital dan berkarakter bela negara.\n'
    ...
    'programKetua': 'Dr. John Doe',
    'programDosen': 'Prof. Jane Smith, Prof. Michael Johnson, Dr. Sarah Lee',
    'programPrestasiTitle': 'Prestasi Kewirausahaan',
    'programPrestasiText': 'Deskripsi singkat tentang prestasi',
    'programPrestasiImage': 'assets/images/prodi/kewirausahaan/MaPres-1.png',
    'programPrestasi':
        '1. Medali perak di kompetisi NASPO (National Applied Science Project Olympiad) 2022.\n'
            '2. Medali perunggu di kompetisi AISEEF (Asean Innovative Science and Entrepreneur Fair) 2023.\n',
    'programPrestasiMahasiswa': '1. Mochamad Rayhan Dwi Cahyo (Kwu 22).\n'
        '2. Rayhan Mauli Al Khudry Pradana (Kwu 22).\n'
        '3. Muhammad Muzakky Abd. Harits (Kwu 22).\n'
        '4. Amanda Citrani Aji (Kwu 22).\n',
  },
  {
    ...
    'programImage': 'assets/images/prodi/akuntansi/gedungakuntansi.png',
    'programWebsite': 'https://akuntansi.upnjatim.ac.id/',
    'programVisi':
        'Menjadi Program Studi Akuntansi yang Unggul di bidang Ilmu Akuntansi yang Berkarakter Bela Negara pada tahun 2039.',
    'programMisi': '1. Menghasilkan akuntan profesional.\n'
    ...
    'programAkreditasi': 'Unggul dan FIBAA',
    'programKetua': 'N/A',
    'programDosen': 'N/A',
    'programPrestasi':
        '1. Juara I National Accounting Essay Competition 2022 Komunitas Jago Akuntansi Indonesia (KJAI).\n'
            ...
            '4. Juara III Esport PUBGM Brawijaya Tournament 2022.\n'
            '5. Medali Emas Bidang Ekonomi dalam OSAN (Olimpiade Sains Akbar Nasional) 2022.',
  },
  {
    ...
    'programImage': 'assets/images/prodi/ekonomi_pembangunan/headerep.png',
    'programWebsite': 'https://ekbang.upnjatim.ac.id/',
    'programVisi':
    ...
    'programMisi': '1. Menyelenggarakan dan mengembangkan pendidikan di bidang Ekonomi Pembangunan berkarakter bela negara.\n'
    ...
    'programKetua': 'N/A',
    'programDosen': 'N/A',
    'programPrestasiTitle': 'Prestasi',
    'programPrestasiText': '',
    'programPrestasiImage': '',
    'programPrestasi': 'Tidak ditemukan prestasi.',
    'programPrestasiMahasiswa': '',
  },
  {
